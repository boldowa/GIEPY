...
cmake $DBG -DJANSSON_WITHOUT_TESTS=ON -DJANSSON_BUILD_SHARED_LIBS=ON -DJANSSON_INSTALL=OFF -DJANSSON_BUILD_DOCS=OFF -DCMAKE_TOOLCHAIN_FILE=../toolchain/mingw-x86.cmake ..; make -j2
sync
